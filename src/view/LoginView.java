...
public class LoginView {
	...
	public LoginView(PApplet app) {
		...
		cp5.addTextfield(inputs[0]).setPosition(71, 453).setSize(232, 38).setAutoClear(true).setColorValue(app.color(255))
        .setColorActive(app.color(0,0,0,1)).setColorBackground(app.color(0,0,0,1)).setColorForeground(app.color(0,0,0,1))
        .setColor(app.color(0,0,0,255)).setColorCursor(app.color(0,0,0,255)).setFont(montserrat).getCaptionLabel().hide();
		
		cp5.addTextfield(inputs[1]).setPosition(71, 544).setSize(232, 38).setPasswordMode(true).setAutoClear(true).setColorValue(app.color(255))
        .setColorActive(app.color(0,0,0,1)).setColorBackground(app.color(0,0,0,1)).setColorForeground(app.color(0,0,0,1))
        .setColor(app.color(0,0,0,255)).setColorCursor(app.color(0,0,0,255)).setFont(montserrat).getCaptionLabel().hide();
